...
<head>
	...
	<link rel="shortcut icon" href="<?php echo $root ?>img/favicon.ico" type="image/gif">
...
<body onload="printMail()">
	...
	<header>
		...
		<object data="<?php echo $root ?>img/icon.svg" type="image/svg+xml">
			<img src="<?php echo $root ?>img/icon.png" height="96" width="96" alt="Vänsterliberalernas logotyp">
		</object>
	</header>
	<div id="content">
		<?php echo $content ?>
